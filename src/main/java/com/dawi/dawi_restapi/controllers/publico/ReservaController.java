...
import com.dawi.dawi_restapi.core.habitacion.repositories.HabitacionRepository;
...
import com.dawi.dawi_restapi.general.helpers.HabitacionMapper;
...
public class ReservaController {
    ...
    public ResponseEntity<?> habitacionesDisponibles(
        ...
        List<HabitacionDTO> disponibles = hotel.getHabitaciones().stream()
